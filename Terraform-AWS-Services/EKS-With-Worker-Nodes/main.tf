...
resource "aws_iam_role" "eks-iam-role" {
  name = "aws-devopsthehardway-eks-iam-role"
...
resource "aws_eks_cluster" "aws-devopsthehardway-eks" {
  name     = "aws-devopsthehardway-eks"
...
resource "aws_eks_node_group" "example" {
  cluster_name    = aws_eks_cluster.aws-devopsthehardway-eks.name
